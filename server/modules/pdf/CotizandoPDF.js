...
function generarPDF(valores){
    ...
    const {rut, nombres, apellidos, celular, email, fecha} = valores;
    ...
    doc.pipe(fs.createWriteStream(path.join(process.cwd() + '/public/pdf/cotizando/CZ-' + rut + '.pdf')));
            ...
            doc.setDocumentHeader({}, () => {
                ...
                doc.fill("#000000")
                    ...
                    fit: [100, 250]})
                    .fontSize(20)
                    .text("Cotizando Kia", doc.header.x, doc.header.y + 15, {align:'center'});
            });
