...
function generarPDF(valores, saveSignature){
    ...
    const {rut, nombres, apellidos, celular, email, fecha, concesionario, tipo_persona} = valores;
    ...
    doc.pipe(fs.createWriteStream(path.join(process.cwd() + '/public/pdf/comprando/CP-' + rut + '.pdf')));
            ...
            doc.setDocumentHeader({}, () => {
                ...
                doc.fill("#000000")
                    ...
                    fit: [100, 250]})
                    .fontSize(20)
                    .text("Comprando Kia", doc.header.x, doc.header.y + 15, {align:'center'});
            });
            ...
            doc.addTable(
                [
                    ...
                    {key: 'tipo_persona', label: 'Tipo Persona', align: 'center'}
                ],
                [{concesionario:concesionario, tipo_persona:tipo_persona}],
                configuracion
            );
